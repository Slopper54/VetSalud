...
/**
 * Jersey REST client generated for REST resource:HistoriaclinicaFacadeREST
 * [entidades.historiaclinica]<br>
 * USAGE:
 * <pre>
 *        historiaclinicaWS client = new historiaclinicaWS();
...
public class historiaclinicaWS {
    ...
    public historiaclinicaWS() {
        ...
        webTarget = client.target(BASE_URI).path("entidades.historiaclinica");
    }
    ...
    public void edit_TEXT(Object requestEntity, String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{id})).request(javax.ws.rs.core.MediaType.TEXT_PLAIN).put(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.TEXT_PLAIN));
    }
